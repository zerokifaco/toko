...
class PenjualanDetailController extends Controller
{
    ...
    public function index()
    {
        ...
        //mengecek apakah Data transaksi sedang berjalan
    ...
    {
        $detail = PenjualanDetail::leftJoin('produk', 'produk.kode_produk', '=', 'penjualan_detail.kode_produk')->where('id_penjualan', '=', $id)
            ->get();
            ...
            //membuat hidden data untuk menghitung total dan total_item
            $data[] = array("<span class='text total'>$total</span>
                                <span class='text totalitem'>$total_item</span>"
                                ,"" ,"" ,"" ,"", "", "", "");
    ...
    public function store(Request $request)
    {
        ...
        //sub total di sesuaikan dengan diskon
    ...
    public function saveData(Request $request)
    {
        ...
        //update data session yang dobeli
    ...
    public function printNota()
    {
        ...
        if($setting->tipe_nota == 0){
            ...
            printer_draw_text($handle, "Nama : ".substr("".Auth::user()->name, -15), 600, 400);
           ...
           printer_draw_text($handle, "No : ".substr("00000000".$penjualan->id_penjualan, -8), 0, 500);
            ...
            foreach($detail as $list){
                ...
                printer_draw_text($handle, substr("".format_uang($harga_jual*$list->jumlah), -10), 800, $y);
                if ($list->diskon !=0 ) {
    ...
    public function notaPDF()
    {
        ...
        $pdf->setPaper(array(0,0,609,440),'portait');
        return $pdf->stream();
    }
}
