            ...
            <form class="form-horizontal" data-toggle="validator" method="post" id="token">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="date('dd-mm-Y')" id="awal" name="awal" class="form-control" autofocus="required">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="date" id="akhir" name="akhir" class="form-control" autofocus="required">
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>     
