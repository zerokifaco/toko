...
<![endif]-->
    ...
    <script src="{{ asset('ace-master/assets/js/jquery.flot.min.js') }}"></script>
    <script src="{{ asset('ace-master/assets/js/jquery.flot.pie.min.js') }}"></script>
    <script src="{{ asset('ace-master/assets/js/jquery.flot.resize.min.js') }}"></script>
